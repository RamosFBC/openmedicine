...
### Changed
- Moved calculator result models into the MCP package namespace.
- Removed remaining non-MCP package namespaces from the distributed package.
- Added regression tests to keep the package scoped to the calculator-only MCP server.
